...
eCore::DB &eCore::DB::operator=(const DB &otherDB)
{
...
mongocxx::database *eCore::DB::db()
{
    return mDB;
}

std::string eCore::DB::downloadFile(const QString &fileOid, bool forceFilename)
{
...
std::string eCore::DB::downloadFileWeb(const QString &fileOid, bool forceFilename)
{
...
bsoncxx::types::value eCore::DB::uploadfile(QString filepath)
{
    auto bucket = this->db ()->gridfs_bucket ();
    QFile file( filepath );
...
mongocxx::stdx::optional<mongocxx::result::insert_one> eCore::DB::insertItem(const Item &item)
{
...
mongocxx::stdx::optional<mongocxx::result::update> eCore::DB::updateItem(const Item &item)
{
...
mongocxx::stdx::optional<bsoncxx::document::value> eCore::DB::findOneItem(const Item &item )
{
    try {
...
mongocxx::stdx::optional<bsoncxx::document::value> eCore::DB::findOneItem(const eCore::Item &item, const eCore::Item &findOptions)
{
...
mongocxx::stdx::optional<mongocxx::cursor> eCore::DB::find(const Item &item, const mongocxx::options::find findOptions)
{
    try {
...
mongocxx::stdx::optional<mongocxx::cursor> eCore::DB::find(const eCore::Item &item, const int &limit, const int &skip)
{
